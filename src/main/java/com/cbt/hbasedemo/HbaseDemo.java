...
public class HbaseDemo {
    ...
    public static Connection initHbase() throws IOException, URISyntaxException {
        ...
        configuration.set("hbase.zookeeper.quorum", "183.213.26.120");
        //集群配置↓
        //configuration.set("hbase.zookeeper.quorum", "101.236.39.141,101.236.46.114,101.236.46.113");
        configuration.set("hbase.master", "183.213.26.120:60000");
    ...
    public static User getDataByRowKey(String tableName, String rowKey) throws IOException, URISyntaxException {
        ...
        if(!get.isCheckExistenceOnly()){
            ...
            user.setUsername(Bytes.toString(result.getValue(Bytes.toBytes( "information" ), Bytes.toBytes( "username" ))));
            //方法二：
            for (Cell cell : result.rawCells()){
                // getQualifierArray() : The array containing the qualifier bytes.
                // getQualifierOffset() : Array index of first qualifier byte
                // getQualifierLength() : Number of qualifier bytes. Must be < qualifierArray.length - offset.
